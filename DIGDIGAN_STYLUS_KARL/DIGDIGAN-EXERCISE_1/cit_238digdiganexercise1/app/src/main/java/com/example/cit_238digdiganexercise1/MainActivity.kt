package com.example.cit_238digdiganexercise1
...
import com.example.cit_238digdiganexercise1.R
...
//Add code below this line in step 9 to Check names are not empty here:
            ...
            if (firstName.isNotEmpty() && lastName.isNotEmpty()) {val nameToDisplay = firstName.plus(" ").plus(lastName)
